...
`)+`
`+r);let U,F,N=g+a+u,E=g+r+c,I=Jr(o,o.VERTEX_SHADER,N),K=Jr(o,o.FRAGMENT_SHADER,E);function P(tt){if(t.debug.checkShaderErrors){let it=o.getProgramInfoLog(v)||"",at=o.getShaderInfoLog(I)||"",X=o.getShaderInfoLog(K)||"",j=it.trim(),k=at.trim(),D=X.trim(),dt=!0,yt=!0;if(o.getProgramParameter(v,o.LINK_STATUS)===!1)if(dt=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(o,v,I,K);else{let qt=eo(o,I,"vertex"),Ft=eo(o,K,"fragment");re("WebGLProgram: Shader Error "+o.getError()+" - VALIDATE_STATUS "+o.getProgramParameter(v,o.VALIDATE_STATUS)+`
